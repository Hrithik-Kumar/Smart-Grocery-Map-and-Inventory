...
- CoS: when the input username and password match, allow the user sign in.
- CoS: if the input username and password does not match, the user will get a notification that their username or password is incorrect. 
...
- CoS: when log out button is clicked, log out and go to the general page.
- Related persona: Peter Walker 
### CustSignUp:7
...
- CoS: new account information (username and password) is saved in backend database, account created.
- Related persona: Peter Walker
### CustProfile:
...
- CoS: when logout button is clicked, log out and return to general page. 
- Related persona: Charles Brown
### CompanySignUp:
...
- CoS: The user's grocery list interface has added one item and transfered its item code to the backend. 
- Related persona: Peter Walker
### CustDeleteItem:
...
- Cos: The user can ask for redesignment by adjusting the given route or changing their preferences.
- Related persona: Peter Walker
### RouteByPrice:
...
- CoS: The users can choose items and check their details by clicking them on the mapUI.
- Related persona: Joan Green
### AppUI:
